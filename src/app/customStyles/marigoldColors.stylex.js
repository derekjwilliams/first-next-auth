...
export const marigoldColors = stylex.defineVars({
  ...
  pansy: pansy,
  textareaBackground: {default: 'rgb(245,245,245)', [DARK]: 'rgb(40, 40, 40)'},
  ...
  foregroundButton: {default: 'rgb(38, 59, 157)',[DARK]: 'rgb(227, 225, 240)'},
  backgroundButton: {default: 'rgb(146, 159, 243)',[DARK]: 'rgb(192, 187, 227)'},
