...
export function textDailyStandup() {
  ...
  listForParagraphTwo.append($createListItemNode().append($createTextNode(`..`)))
  ...
  listForParagraphThree.append($createListItemNode().append($createTextNode(`..`)))
  ...
  listForParagraphFour.append($createListItemNode().append($createTextNode(`..`)))
